...
public final class OutputPanelLoader extends JPanel {
     ...
     * colour to the one created, this colour is default. The
     * text field is also set as empty.
     * */
    ...
    /** void setLabelPasswordFailedText, sets the lblPassedFailed text
    ...
    /** void addSubmitListener, adds a event listener to the btnSaveResults control.
    ...
    /** void setTextField, sets the overviewResults text to the 
     * parameter string.
     * @param text, the text that will be set. 
     * */
    ...
    /** String getOverviewText, returns the text in the text area control
     * @return the text in the overviewResults control.
     * */
    public String getOverviewText() {
        return overviewResults.getText();
    }

    /** void resetPosition, sets the position of the text area to 0,
     * used to change the position of the scroll bar to the top.
     * */
